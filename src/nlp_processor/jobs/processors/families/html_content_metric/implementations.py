from src.nlp_processor.jobs.processors.families.html_content_metric._template import \
    ExtractHTMLContentMetricProcessorTemplate
from src.nlp_processor.jobs.processors.families.html_content_metric.factory import \
    make_html_content_metric_link_direction_processor
from src.nlp_processor.jobs.enums import HTMLContentMetricJobType
