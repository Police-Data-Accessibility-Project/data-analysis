from core.database_logic.models import HTMLMetadata, URLComponent, HTMLContentMetric, HTMLBagOfWords
from core.nlp_processor.v2.families.enums import FamilyType
from core.nlp_processor.v2.families.registry.core import FamilyRegistry
from core.nlp_processor.v2.families.registry.entry import FamilyRegistryEntry
from core.nlp_processor.v2.jobs.result.implementations import HTMLMetadataJobResult, URLComponentJobResult, \
